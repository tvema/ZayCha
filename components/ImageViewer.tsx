...
export const ImageViewer = ({ src, alt, onClose }: { src: string, alt: string, onClose: () => void }) => {
  ...
  return (
    ...
    >
      {/* Top Controls */}
      <div className="absolute top-0 inset-x-0 p-4 flex justify-end items-center z-10 bg-gradient-to-b from-black/60 to-transparent">
      ...
      >
        <motion.div
           ...
           style={{ scale: scaleMV, rotate: rotation, x, y }}
           className="relative"
        >
          <img 
            ref={imageRef}
